...
@ActionDescriptor(
        name = "GMU export",
		description = "Exports entities and all dependencies from a Gateway.",
        category="CA.APIM.GatewayMigrationUtility" )
    public class GMUExport extends Action {
    private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(GMUExport.class);
	...
	@ParameterDescriptor(
		name = "Properties file path",
		description = "Location of the property file",
		out = false,
		in = true,
		nullable = false, // parameter is required and no default value set
		order = 20,
        defaultValueAsString = ""
            ...
            private String propertiesfilepath2 = "$inputDefaultValue";
	...
	@ParameterDescriptor(
        ...
        defaultValueAsString = ""
            ...
            private String exportfilepath3 = "$inputDefaultValue";
    

	@ParameterDescriptor(
		name = "API operation type",
		description = "Type of API operation to export",
		out = false,
		in = true,
		nullable = false, // parameter is required and no default value set
		order = 40,
        defaultValueAsString = ""
            ...
            private String apioperationtype4 = "$inputDefaultValue";
    

	@ParameterDescriptor(
		name = "API operation id",
		description = "Type of API Id to export",
		out = false,
		in = true,
		nullable = false, // parameter is required and no default value set
		order = 50,
        defaultValueAsString = ""
            ...
            private String apioperationid5 = "$inputDefaultValue";
    ...
    public void setgmubinpath1(String gmubinpath1) {
    	this.gmubinpath1 = gmubinpath1;
	        ...
	        public String getpropertiesfilepath2() {
        return propertiesfilepath2;
    }
    
    public void setpropertiesfilepath2(String propertiesfilepath2) {
    	this.propertiesfilepath2 = propertiesfilepath2;
    }
	        public String getexportfilepath3() {
        return exportfilepath3;
    }
    
    public void setexportfilepath3(String exportfilepath3) {
    	this.exportfilepath3 = exportfilepath3;
    }
	        public String getapioperationtype4() {
        return apioperationtype4;
    }
    
    public void setapioperationtype4(String apioperationtype4) {
    	this.apioperationtype4 = apioperationtype4;
    }
	        public String getapioperationid5() {
        return apioperationid5;
    }
    
    public void setapioperationid5(String apioperationid5) {
    	this.apioperationid5 = apioperationid5;
    }
	    // Getters and Setters
	...
	private ActionResult getActionResult(com.ca.nolio.rdk.dto.CLIAction action) {
 	...
 	private List<InputParam> getInput() {
			...
			inputParameters.add(p);		
					p = new InputParam();
			p.setName("Properties file path");
			 p.setDescription("Location of the property file");
             p.setDefaultValue("2147483647");
             p.setPrefix("");
			//p.setValue("LabGateway.properties");
			p.setVariableName("propertiesfilepath");
			p.setType(VarType.String);

									    			 				p.setValue( propertiesfilepath2 );
			...
			p.setType(VarType.String);
									    			 				...
									    			 				p.setValue( exportfilepath3 );
			 								
			inputParameters.add(p);		
					p = new InputParam();
			p.setName("API operation type");
			 p.setDescription("Type of API operation to export");
             p.setDefaultValue("2147483647");
             p.setPrefix("");
			//p.setValue("policy");
			p.setVariableName("apioperationtype");
			p.setType(VarType.String);

									    			 				p.setValue( apioperationtype4 );
			 								
			inputParameters.add(p);		
					p = new InputParam();
			p.setName("API operation id");
			 p.setDescription("Type of API Id to export");
             p.setDefaultValue("2147483647");
             p.setPrefix("");
			//p.setValue("5434c32066a6b76029f6531a3238fcf1");
			p.setVariableName("apioperationid");
			p.setType(VarType.String);

									    			 				p.setValue( apioperationid5 );
	...
	private List<CliCommand> getCliCommands(){
		...
		Script script = null;
					...
					cliCmd.setCommand("${GMU bin path}/GatewayMigrationUtility.sh migrateOut --argFile ${Properties file path} --dest ${Export file path} --${API operation type} ${API operation id}");											
...
private com.ca.nolio.rdk.dto.CLIAction getCLIAction() {
	...
	action.setName("GMU export");
	action.setDescription("Exports entities and all dependencies from a Gateway.");
