...
@ActionDescriptor(
        name = "GMU import",
		description = "Use to import (create/update/delete entities) to a Gateway.",
        category="CA.APIM.GatewayMigrationUtility" )
    public class GMUImport extends Action {
    private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(GMUImport.class);
	...
	@ParameterDescriptor(
        ...
        defaultValueAsString = ""
            ...
            private String propertiesfilepath4 = "$inputDefaultValue";
    ...
    public void settemplatefilepath3(String templatefilepath3) {
    	this.templatefilepath3 = templatefilepath3;
	        ...
	        public String getpropertiesfilepath4() {
        return propertiesfilepath4;
    }
    
    public void setpropertiesfilepath4(String propertiesfilepath4) {
    	this.propertiesfilepath4 = propertiesfilepath4;
    }
	    // Getters and Setters
	...
	private ActionResult getActionResult(com.ca.nolio.rdk.dto.CLIAction action) {
 	...
 	private List<InputParam> getInput() {
			...
			p.setName("Properties file path");
			 p.setDescription("Location of the properties file");
             p.setDefaultValue("2147483647");
             p.setPrefix("");
			...
			p.setType(VarType.String);
									    			 				...
									    			 				p.setValue( propertiesfilepath4 );
	...
	private List<CliCommand> getCliCommands(){
		...
		Script script = null;
					...
					cliCmd.setCommand("${GMU bin path}/GatewayMigrationUtility.sh migrateIn --bundle ${Export file path} --template ${Template file path} --argFile ${Properties file path}");											
...
private com.ca.nolio.rdk.dto.CLIAction getCLIAction() {
	...
	action.setName("GMU import");
	action.setDescription("Use to import (create/update/delete entities) to a Gateway.");
